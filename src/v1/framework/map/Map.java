...
import v1.framework.Console;
import v1.framework.mapUtils;
import v1.framework.util.msgType;
import v1.framework.util.IdiotException;
...
public class Map {
    ...
    public Map(Robot robot) {
        ...
        Console.log("Initial v1.framework.map.Map created", msgType.SUCCESS);
    }
