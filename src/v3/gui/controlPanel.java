...
import v3.gui.components.Button;
...
public class controlPanel extends JPanel {
    ...
    public controlPanel(Pathfinder pathfinder) {
        ...
        sliderInfo.setBackground(new java.awt.Color(0, 45, 120));
        sliderInfo.setForeground(new java.awt.Color(205, 205, 205));
        sliderInfo.setFont(guiUtils.customFont(14f));
        sliderInfo.setBorder(BorderFactory.createLineBorder(new java.awt.Color(17, 23, 41), 2));
